...
def pipeline(
    ...
    graph = networkx_graph_from_nparrays(
        nodes_nparray=transform_node_tuple_to_two_fields(nodes_nparray),
        edges_nparray=transform_edge_tuple_to_three_fields(edges_nparray),
...
if __name__ == "__main__":
    ...
    logger.info("Number of nodes(array): {}".format(nodes_ds.size))
    logger.info("Number of edges(array): {}".format(edges_ds.size))
